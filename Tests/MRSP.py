...
task_1 = TaskFactory.create_instance(TaskTypeList.TERMINAL, name='Task_1_1', type='Default', phase=Time(0), deadline=Time(6), periodicity=PeriodicityTypeList.PERIODIC, preemptability=PreemptionTypeList.NOT_PPREEMPTABLE, token_name=['__Task_1_1__'])
