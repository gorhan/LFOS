	...
	\resizebox{1.2\textwidth}{!}{
		\begin{tikzpicture}[ampersand replacement=\&]
			...
			\matrix (task)[matrix of nodes,
				...
				\begin{tabular}{c} Priority \\ $\mathcal{T}_{prio}$ \end{tabular}  \& %task-1-4
				\begin{tabular}{c} Dependency \\ $\mathcal{T}_{dep}$ \end{tabular}  \& %task-1-4
...
%			\connectfeaturesii{man}{task-1-4}{preemptable-1-1};
...
%				Minimize \& %objective-task-1-4
%				Criteria \\ %objective-task-1-4
%			};
%			
%			\connectfeaturesiii{xor}{task-1-5}{objective-task-1-1}{objective-task-1-4};
%			\connectfeaturesii{man}{task-1-5}{objective-task-1-4};
			
		\end{tikzpicture}
	}
	\caption{A configured \emph{Task} sub-feature model for TSP.}
\end{figure}