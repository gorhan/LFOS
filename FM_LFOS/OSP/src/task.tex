...
%				\begin{tabular}{c} Dependency \\ $\mathcal{T}_{dep}$ \end{tabular}  \& %task-1-2
%				\begin{tabular}{c} Preemptable \\ $\mathcal{T}_{pmtn}$ \end{tabular}  \& %task-1-2
...
%			\connectfeaturesii{man}{task-1-2}{preemptable-1-1};
...
%				\begin{tabular}{c} Firm \\ Deadline \end{tabular} \& %deadline-requirement-1-2
			...
			\connectfeaturesii{man}{task-1-3}{requirement-1-3};
			
			\connectfeaturesii{man}{requirement-1-3}{deadline-requirement-1-1};
...
%				Criteria \\ %objective-task-1-2
%			};
%			
%			\connectfeaturesiii{xor}{task-1-5}{objective-task-1-1}{objective-task-1-2};
%			\connectfeaturesii{man}{task-1-5}{objective-task-1-2};
			
		\end{tikzpicture}
	}
	\caption{A configured \emph{Task} sub-feature model for OSP.}
\end{figure}