\begin{figure}[H]
	...
	\resizebox{1.\textwidth}{!}{
		\begin{tikzpicture}[ampersand replacement=\&]
			\node[feature] (sub-scheduler) {Resource ($\mathcal{R}_1$)};
...
%				Continuous-State \\ %scalable-1-2
			...
			\connectfeaturesii{man}{resource-1-4}{powcons-1-1};
			\connectfeaturesii{man}{powcons-1-1}{scalable-1-1};
...
%			\connectfeaturesii{man}{resource-1-5}{objective-resource-1-3};
	...
	\caption{A configured \emph{Resource} ($\mathcal{R}_1$) sub-feature model for MRSP.}
\end{figure}
...
\begin{figure}[H]
	...
	\resizebox{1.\textwidth}{!}{
		\begin{tikzpicture}[ampersand replacement=\&]
		\node[feature] (sub-scheduler) {Resource ($\mathcal{R}_2$)};
...
%		\connectfeaturesii{man}{powcons-1-1}{scalable-1-1};
	...
	\caption{A configured \emph{Resource} ($\mathcal{R}_2$) sub-feature model for MRSP.}
\end{figure}