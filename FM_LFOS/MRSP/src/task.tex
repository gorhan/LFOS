\begin{figure}[H]
	...
	\resizebox{1.2\textwidth}{!}{
		\begin{tikzpicture}[ampersand replacement=\&]
			\node[feature] (sub-scheduler) {Task ($\mathcal{T}_1$)};
...
%				\begin{tabular}{c} Preemptable \\ $\mathcal{T}_{prmp}$ \end{tabular}  \& %task-1-3
				\begin{tabular}{c} Requirement \\ $\mathcal{T}_{req}$ \end{tabular}  \& %task-1-3
				\begin{tabular}{c} Granularity \\ $\mathcal{T}_{gran}$ \end{tabular}  \\ %task-1-4
%				\begin{tabular}{c} Objective \\ $\mathcal{T}_{obj}$ \end{tabular} \\ %task-1-5
			};
			
			% Timing sub-feature diagram is drawn
			\matrix (timing)[matrix of nodes,
					  below left=2.5cm and -3cm of task-1-1,
...
%				\begin{tabular}{c} Firm \\ Deadline \end{tabular} \& %deadline-requirement-1-2
				\begin{tabular}{c} Hard \\ Deadline \end{tabular} \\ %deadline-requirement-1-3
			};
			
			\connectfeaturesii{man}{task-1-3}{requirement-1-1};
%			\connectfeaturesii{opt}{task-1-3}{requirement-1-2};
			\connectfeaturesii{man}{task-1-3}{requirement-1-2};
...
%				\begin{tabular}{c} Terminal \\ Task \end{tabular} \& %granularity-1-1
			...
			\connectfeaturesii{man}{task-1-4}{granularity-1-1};
...
%			};
%			
%			\connectfeaturesiii{xor}{task-1-5}{objective-task-1-1}{objective-task-1-2};
%			\connectfeaturesii{man}{task-1-5}{objective-task-1-3};
			
		\end{tikzpicture}
	}
	\caption{A configured \emph{Task} ($\mathcal{T}_1$) sub-feature model for MRSP.}
\end{figure}
...
\begin{figure}[H]
	...
	\resizebox{1.2\textwidth}{!}{
		\begin{tikzpicture}[ampersand replacement=\&]
		\node[feature] (sub-scheduler) {Task ($\mathcal{T}_2$)};
		...
		column sep=15mm, row sep=0mm, nodes=feature]{
			...
			\begin{tabular}{c} Priority \\ $\mathcal{T}_{prio}$ \end{tabular}  \& %task-1-2
			\begin{tabular}{c} Dependency \\ $\mathcal{T}_{dep}$ \end{tabular}  \& %task-1-3
			\begin{tabular}{c} Preemptable \\ $\mathcal{T}_{pmtn}$ \end{tabular}  \& %task-1-4
		...
		%			\connectfeaturesii{opt}{task-1-3}{requirement-1-2};
		\connectfeaturesii{man}{task-1-5}{requirement-1-2};
		...
		\connectfeaturesii{man}{task-1-6}{granularity-1-1};
	...
	\caption{A configured \emph{Task} ($\mathcal{T}_2$) sub-feature model for MRSP.}
\end{figure}