	...
	\resizebox{1.6\textwidth}{!}{
		\begin{tikzpicture}[ampersand replacement=\&]
			...
			\matrix (sched)[matrix of nodes,
				...
				\begin{tabular}{c} Preemptive \\ $\mathcal{C}_{pmtn}$ \end{tabular}  \& %sched-1-2
				\begin{tabular}{c} Migration \\ $\mathcal{C}_{mig}$ \end{tabular}  \& %sched-1-2
				\begin{tabular}{c} Scheduling \\ Policy $\mathcal{C}_{pol}$ \end{tabular}  \& %sched-1-3
				\begin{tabular}{c} Time \\ Resolution $\mathcal{C}_{tres}$ \end{tabular}  \& %sched-1-4
				\begin{tabular}{c} Priority \\ Assignment $\mathcal{C}_{prio}$ \end{tabular} \& %sched-1-5
				\begin{tabular}{c} Scheduling \\ Window $\mathcal{C}_{window}$ \end{tabular} \& %sched-1-6
				\begin{tabular}{c} Objective \\ $\mathcal{C}_{obj}$ \end{tabular} \\ %sched-1-7
			};
			...
			\connectfeaturesii{man}{sub-sched-char}{sched-1-8};
...
%				Grouping \& %policy-1-1
			...
			\connectfeaturesii{man}{sched-1-4}{policy-1-1};
%			\connectfeaturesii{man}{sched-1-3}{policy-1-2};
...
%				Dynamic \\ %priority-1-2
			...
			\connectfeaturesii{man}{sched-1-5}{priority-1-1};
...
%				Maximize \& %sched-objective-1-1
			...
			\connectfeaturesii{man}{sched-1-8}{sched-objective-1-1}
			\connectfeaturesii{man}{sched-1-8}{sched-objective-1-2}
...
%				Abstract \\ %sched-criteria-1-3
			...
			\connectfeaturesii{man}{sched-objective-1-2}{sched-criteria-1-2};
%			\connectfeaturesiii{or}{sched-objective-1-3}{sched-criteria-1-1}{sched-criteria-1-3};
		
		\end{tikzpicture}
	}
	\caption{A configured \emph{Scheduling Characteristics} sub-feature model for MRSP.}
\end{figure}