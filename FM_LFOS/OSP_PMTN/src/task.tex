...
%				\begin{tabular}{c} Dependency \\ $\mathcal{T}_{dep}$ \end{tabular}  \& %task-1-3
				\begin{tabular}{c} Preemptable \\ $\mathcal{T}_{pmtn}$ \end{tabular}  \& %task-1-3
...
%				\begin{tabular}{c} Firm \\ Deadline \end{tabular} \& %deadline-requirement-1-2
			...
			\connectfeaturesii{man}{task-1-4}{requirement-1-3};
...
%			\connectfeaturesii{man}{task-1-6}{objective-task-1-3};
	...
	\caption{A configured \emph{Task} sub-feature model for OSP-PMTN.}
\end{figure}