...
%			};
%			\connectfeaturesii{man}{sched-1-2}{migration-1-1};
...
%				Grouping \& %policy-1-1
			...
			\connectfeaturesii{man}{sched-1-3}{policy-1-1};
...
%				Maximize \& %sched-objective-1-1
			...
			\connectfeaturesii{man}{sched-1-7}{sched-objective-1-1}
			\connectfeaturesii{man}{sched-1-7}{sched-objective-1-2}
...
%			\connectfeaturesiii{or}{sched-objective-1-3}{sched-criteria-1-1}{sched-criteria-1-3};
	...
	\caption{A configured \emph{Scheduling Characteristics} sub-feature model for OSP-PMTN.}
\end{figure}