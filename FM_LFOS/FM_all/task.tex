	...
	\resizebox{1.6\textwidth}{!}{
		\begin{tikzpicture}[ampersand replacement=\&]
			...
			\matrix (task)[matrix of nodes,
					  ...
					  column sep=35mm, row sep=0mm, nodes=feature]{
				...
				\begin{tabular}{c} Preemptable \\ $\mathcal{T}_{prmp}$ \end{tabular}  \& %task-1-4
				\begin{tabular}{c} Requirement \\ $\mathcal{T}_{req}$ \end{tabular}  \& %task-1-5
				\begin{tabular}{c} Granularity \\ $\mathcal{T}_{gran}$ \end{tabular}  \& %task-1-6
				\begin{tabular}{c} Objective \\ $\mathcal{T}_{obj}$ \end{tabular} \\ %task-1-7
			};
			...
			\connectfeaturesii{opt}{sub-scheduler}{task-1-3};
			\connectfeaturesii{opt}{sub-scheduler}{task-1-4};
			\connectfeaturesii{man}{sub-scheduler}{task-1-5};
			\connectfeaturesii{man}{sub-scheduler}{task-1-6};
			\connectfeaturesii{opt}{sub-scheduler}{task-1-7};
			...
			\connectfeaturesiii{xor}{timing-1-4}{periodicity-1-1}{periodicity-1-2};
			
			\connectfeaturesii{opt}{periodicity-1-2}{aperiodic-1-1};
			...
			\connectfeaturesii{man}{task-1-5}{requirement-1-1};
			\connectfeaturesii{opt}{task-1-5}{requirement-1-2};
			\connectfeaturesii{man}{task-1-5}{requirement-1-3};
			
			\connectfeaturesii{opt}{requirement-1-3}{deadline-requirement-1-1};
			\connectfeaturesii{opt}{requirement-1-3}{deadline-requirement-1-2};
			\connectfeaturesii{opt}{requirement-1-3}{deadline-requirement-1-3};
			...
			\matrix (granularity)[matrix of nodes,
				...
				\begin{tabular}{c} Composite \\ Task \end{tabular} \\ %granularity-1-2
			};
			
			\connectfeaturesiii{xor}{task-1-6}{granularity-1-1}{granularity-1-2};
			...
			\connectfeaturesiii{xor}{task-1-7}{objective-task-1-1}{objective-task-1-2};
			\connectfeaturesii{man}{task-1-7}{objective-task-1-3};
			
		\end{tikzpicture}
	}
	\caption{A feature model representation of tasks.}
	\label{fig:task_fm}
\end{figure}