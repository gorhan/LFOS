\begin{figure*}[!ht]
	...
	\resizebox{1.6\textwidth}{!}{
		\begin{tikzpicture}[ampersand replacement=\&]
			...
			\draw (type-1-1.south) -- (abstraction-1-1.north);\draw[opt] (abstraction-1-1.north) circle (.9mm);
			...
			\draw (resource-1-3.south) -- (mode-1-1.north);\draw[opt] (mode-1-1.north) circle (.9mm);
	...
	\caption{A feature model representation for resources.}
	\label{fig:resource_fm}
\end{figure*}