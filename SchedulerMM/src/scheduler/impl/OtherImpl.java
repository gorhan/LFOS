 ...
 * </p>
 * <ul>
 *   <li>{@link scheduler.impl.OtherImpl#getTimeCutoff <em>Time Cutoff</em>}</li>
 *   <li>{@link scheduler.impl.OtherImpl#getVerboseLevel <em>Verbose Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OtherImpl extends MinimalEObjectImpl.Container implements Other {
	...
	protected EClass eStaticClass() {
		return SchedulerPackage.Literals.OTHER;
	}
	...
	public void setTimeCutoff(int newTimeCutoff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.OTHER__TIME_CUTOFF, oldTimeCutoff, timeCutoff));
	}
	...
	public void setVerboseLevel(int newVerboseLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.OTHER__VERBOSE_LEVEL, oldVerboseLevel, verboseLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulerPackage.OTHER__TIME_CUTOFF:
				return getTimeCutoff();
			case SchedulerPackage.OTHER__VERBOSE_LEVEL:
