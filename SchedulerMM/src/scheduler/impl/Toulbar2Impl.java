...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Toulbar2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link scheduler.impl.Toulbar2Impl#getTimeCutoff <em>Time Cutoff</em>}</li>
 *   <li>{@link scheduler.impl.Toulbar2Impl#getVerboseLevel <em>Verbose Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Toulbar2Impl extends MinimalEObjectImpl.Container implements Toulbar2 {
	/**
	...
	protected EClass eStaticClass() {
		return SchedulerPackage.Literals.TOULBAR2;
	}
	...
	public void setTimeCutoff(int newTimeCutoff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.TOULBAR2__TIME_CUTOFF, oldTimeCutoff, timeCutoff));
	}
	...
	public void setVerboseLevel(int newVerboseLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.TOULBAR2__VERBOSE_LEVEL, oldVerboseLevel, verboseLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulerPackage.TOULBAR2__TIME_CUTOFF:
				return getTimeCutoff();
			case SchedulerPackage.TOULBAR2__VERBOSE_LEVEL:
