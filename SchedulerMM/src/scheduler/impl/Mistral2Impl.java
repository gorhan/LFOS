...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Mistral2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link scheduler.impl.Mistral2Impl#getTimeCutoff <em>Time Cutoff</em>}</li>
 *   <li>{@link scheduler.impl.Mistral2Impl#getVerboseLevel <em>Verbose Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Mistral2Impl extends MinimalEObjectImpl.Container implements Mistral2 {
	/**
	...
	protected EClass eStaticClass() {
		return SchedulerPackage.Literals.MISTRAL2;
	}
	...
	public void setTimeCutoff(int newTimeCutoff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.MISTRAL2__TIME_CUTOFF, oldTimeCutoff, timeCutoff));
	}
	...
	public void setVerboseLevel(int newVerboseLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.MISTRAL2__VERBOSE_LEVEL, oldVerboseLevel, verboseLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulerPackage.MISTRAL2__TIME_CUTOFF:
				return getTimeCutoff();
			case SchedulerPackage.MISTRAL2__VERBOSE_LEVEL:
