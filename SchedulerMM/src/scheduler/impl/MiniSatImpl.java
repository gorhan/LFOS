 ...
 * </p>
 * <ul>
 *   <li>{@link scheduler.impl.MiniSatImpl#getTimeCutoff <em>Time Cutoff</em>}</li>
 *   <li>{@link scheduler.impl.MiniSatImpl#getVerboseLevel <em>Verbose Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MiniSatImpl extends MinimalEObjectImpl.Container implements MiniSat {
	...
	protected EClass eStaticClass() {
		return SchedulerPackage.Literals.MINI_SAT;
	}
	...
	public void setTimeCutoff(int newTimeCutoff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.MINI_SAT__TIME_CUTOFF, oldTimeCutoff, timeCutoff));
	}
	...
	public void setVerboseLevel(int newVerboseLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.MINI_SAT__VERBOSE_LEVEL, oldVerboseLevel, verboseLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulerPackage.MINI_SAT__TIME_CUTOFF:
				return getTimeCutoff();
			case SchedulerPackage.MINI_SAT__VERBOSE_LEVEL:
