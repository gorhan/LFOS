...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sat Wrapper</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link scheduler.impl.SatWrapperImpl#getTimeCutoff <em>Time Cutoff</em>}</li>
 *   <li>{@link scheduler.impl.SatWrapperImpl#getVerboseLevel <em>Verbose Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SatWrapperImpl extends MinimalEObjectImpl.Container implements SatWrapper {
	/**
	...
	protected EClass eStaticClass() {
		return SchedulerPackage.Literals.SAT_WRAPPER;
	}
	...
	public void setTimeCutoff(int newTimeCutoff) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.SAT_WRAPPER__TIME_CUTOFF, oldTimeCutoff, timeCutoff));
	}
	...
	public void setVerboseLevel(int newVerboseLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.SAT_WRAPPER__VERBOSE_LEVEL, oldVerboseLevel, verboseLevel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulerPackage.SAT_WRAPPER__TIME_CUTOFF:
				return getTimeCutoff();
			case SchedulerPackage.SAT_WRAPPER__VERBOSE_LEVEL:
