...
/**
 * This is the item provider adapter for a {@link Connection.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_operation_feature", "_UI_Input_type"),
				 ProcessPackage.Literals.INPUT__OPERATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProcessPackage.Literals.INPUT__DATA);
		}
	...
	public String getText(Object object) {
		LogicalOperation labelValue = ((Input)object).getOperation();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Input.class)) {
			case ProcessPackage.INPUT__OPERATION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProcessPackage.Literals.INPUT__DATA,
