...
/**
 * This is the item provider adapter for a {@link Connection.Data} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_amount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_amount_feature", "_UI_Data_type"),
				 ProcessPackage.Literals.DATA__AMOUNT,
				 true,
				 false,
				 false,
	...
	protected void addProducedByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Data_producedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Data_producedBy_feature", "_UI_Data_type"),
				 ProcessPackage.Literals.DATA__PRODUCED_BY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Data_type") + " " + data.getAmount();
	}
