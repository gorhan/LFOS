...
/**
 * This is the item provider adapter for a {@link Connection.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends ProcessNodeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_period_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_period_feature", "_UI_Process_type"),
				 ProcessPackage.Literals.PROCESS__PERIOD,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Connection.Process)object).getName();
