 ...
 * </p>
 * <ul>
 *   <li>{@link Connection.impl.InputListImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link Connection.impl.InputListImpl#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputListImpl extends MinimalEObjectImpl.Container implements InputList {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.INPUT_LIST;
	}
	...
	public void setOperation(LogicalOperation newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.INPUT_LIST__OPERATION, oldOperation, operation));
	}
	 ...
	 * @generated
	 */
	public EList<Input> getItem() {
		if (item == null) {
			item = new EObjectContainmentEList<Input>(Input.class, this, ProcessPackage.INPUT_LIST__ITEM);
		}
		return item;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ProcessPackage.INPUT_LIST__ITEM:
				getItem().clear();
				getItem().addAll((Collection<? extends Input>)newValue);
				return;
		}
