...
/**
 * This is the item provider adapter for a {@link platformMM.ResourceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_identifier_feature", "_UI_ResourceType_type"),
				 PlatformMMPackage.Literals.RESOURCE_TYPE__IDENTIFIER,
				 true,
				 false,
				 false,
	...
	protected void addAbstractionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_abstraction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_abstraction_feature", "_UI_ResourceType_type"),
				 PlatformMMPackage.Literals.RESOURCE_TYPE__ABSTRACTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ResourceType)object).getIdentifier();
