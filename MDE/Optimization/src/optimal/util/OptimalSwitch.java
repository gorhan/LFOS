 ...
 * @generated
 */
public class OptimalSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OptimalPackage.OPTIMIZATION: {
				Optimization optimization = (Optimization)theEObject;
				T result = caseOptimization(optimization);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OptimalPackage.CRITERIA: {
				Criteria criteria = (Criteria)theEObject;
				T result = caseCriteria(criteria);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OptimalPackage.FEATURE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Optimization</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Optimization</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOptimization(Optimization object) {
		return null;
	}
